...
class BuildAnalyzer:
    ...
    def _run_tests(self, app: Application) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                for line in env.run_shell_command(["pytest"] if env_name == "test" else ["hatch", "run", "test"]):
    ...
    def _find_test_env(self, app: Application) -> Optional[str]:
    ...
    def _find_format_env(self, app: Application) -> Optional[str]:
    ...
    def _find_type_env(self, app: Application) -> Optional[str]:
